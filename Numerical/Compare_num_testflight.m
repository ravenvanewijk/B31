...
% ylabel('\alpha [rad]')
% subplot(2,1,2)
plot(t1, y1(:,4)+0.004541,time1,[q1,elev])
legend('numerical','test','\delta_e [rad]')
title('Pitch rate')
grid minor
xlabel('time [s]')
...
% % grid minor
% subplot(2,1,1)
% plot( t4,-y4(:,3)-0.003695-0.01,time4, [rollrate2])
% title('Roll rate')
% legend('numerical','test')
% xlabel('time [s]')
% ylabel('p [rad/s]')
% grid minor
% subplot(2,1,2)
% plot( t4,y4(:,4)+0.01,time4, [yawrate2])
% legend('numerical','test')
% xlabel('time [s]')
% ylabel('r [rad/s]')
% title('Yaw rate')
...
% 
% subplot(3,1,1)
% plot(t5, -y5(:,3)-0.0,time5, [rollrate3])
% title('Roll rate')
% legend('numerical','test')
% xlabel('time [s]')
% ylabel('p [rad/s]')
% grid minor
% subplot(3,1,2)
% plot(t5, -y5(:,4)-0.002761, time5, [yawrate3])
% title('Yaw rate')
% legend('numerical','test')
% xlabel('time [s]')
% ylabel('r [rad/s]')
